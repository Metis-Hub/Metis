...
if (isset($_POST["pw_old"]) && isset($_SESSION["safe_password_seed"])) {
	if(isset($_POST["pw"])) {
		if(strlen(decrypt($_SESSION["safe_password_seed"], $_POST["pw"])) < 8) {
			echo $text0 . "<script type=\"text/JavaScript\">alert(unescape(\"Das neue Passwort muss mindestens 8 Stellen lang sein%21\"));window.location.href=\"./../settings/\";</script>" . $text1;
		}
